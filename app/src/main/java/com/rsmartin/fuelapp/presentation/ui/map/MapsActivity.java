...
public class MapsActivity extends FragmentActivity implements GoogleMap.OnMarkerClickListener, OnMapReadyCallback {
    ...
    private List<DatosGasolinera> auxList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ListaDatosGasolineras listaDatosGasolineras = (ListaDatosGasolineras) getIntent().getSerializableExtra("value");
            if (listaDatosGasolineras != null)
                auxList = listaDatosGasolineras.getDatosGasolineraList();
        }
...
//
//            for (DatosGasolineraEntity p : cluster.getItems()) {
//                // Draw 4 at most.
