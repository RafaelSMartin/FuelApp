package com.rsmartin.fuelapp.presentation.ui.main;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //List<DatosGasolineraEntity> auxList = AppDB.getInstance(getApplicationContext()).listaEESSPrecioWraperDAO().findAllListaPrecioWraper();


//        TextView tv = findViewById(R.id.textView_hello);
//        StringBuilder auxString = new StringBuilder("cargando");
//
//        for(DatosGasolineraEntity aux : auxList) {
