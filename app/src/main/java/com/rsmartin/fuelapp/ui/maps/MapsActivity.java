...
public class MapsActivity extends FragmentActivity implements GoogleMap.OnMarkerClickListener, OnMapReadyCallback {
    ...
    private List<ListaEESSPrecioWraper> auxList;
    private ClusterManager<ListaEESSPrecioWraper> mClusterManager;
...
//        try {
//            auxList = findAllListaPrecioWraperTask.execute().get();
...
//        getWindowManager().getDefaultDisplay().getMetrics(metrics);
        ...
        mClusterManager = new ClusterManager<ListaEESSPrecioWraper>(this, getMap());
        ...
        mClusterManager.setAlgorithm(new NonHierarchicalDistanceBasedAlgorithm<ListaEESSPrecioWraper>());
...
//                    .setTag(0);
    ...
    public class CustomMarkerClustering extends DefaultClusterRenderer<ListaEESSPrecioWraper> {
        ...
        public CustomMarkerClustering(Context context, GoogleMap map,
                                      ClusterManager<ListaEESSPrecioWraper> clusterManager) {
            super(context, map, clusterManager);
            this.mDensity = context.getResources().getDisplayMetrics().density;
            this.mClusterIconGenerator = new IconGenerator(getApplicationContext());
            this.mIconGenerator = new IconGenerator(context);
            this.mIconGenerator.setContentView(this.makeSquareTextView(context));
            this.mIconGenerator.setTextAppearance(R.style.fuelapp_ClusterIcon_TextAppearance);
        ...
        @Override
        protected void onBeforeClusterItemRendered(ListaEESSPrecioWraper item, MarkerOptions markerOptions) {
            // Draw a single person.
            // Set the info window to show their name.
//            mImageView.setImageResource(android.R.drawable.btn_default);
//            Bitmap icon = mIconGenerator.makeIcon();
//            markerOptions.icon(BitmapDescriptorFactory.fromBitmap(icon)).title(item.getRotulo());
        }

        @Override
        protected void onBeforeClusterRendered(Cluster<ListaEESSPrecioWraper> cluster, MarkerOptions markerOptions) {
...
//
//            for (ListaEESSPrecioWraper p : cluster.getItems()) {
//                // Draw 4 at most.
...
//            }
//            Drawable multiDrawable = new DrawableContainer(profilePhotos);
